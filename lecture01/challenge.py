...
def main(
    ...
    for step in range(1, num_steps+1):
        ...
        l_student,g_student = loss_and_grad_fn(w_student, w_teacher)
        l_teacher, g_teacher = loss_and_grad_fn(w_teacher, w_student)

        w_student = w_student - learning_rate*g_student
        w_teacher = w_teacher - learning_rate*g_teacher

        plot = vis(w_student, w_teacher, step, l_student)
